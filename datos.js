...
var patagoniaPhotos = [
    ...
    { name:'Puerto Natales', url:'https://drive.google.com/thumbnail?id=1-o2SJrZDqQE64vESRbYExBcEH1lzHaPW&sz=w400', zone:'austral', nota:'Puerta a Torres del Paine, fiordo de Última Esperanza.' },
    { name:'Lago Grey', url:'https://drive.google.com/thumbnail?id=1NpBgGLaGErifAqGG0m5cjJR2zfmB07x7&sz=w400', zone:'austral', nota:'Hielo milenario navegando el agua.' },
    { name:'Glaciar Grey', url:'https://drive.google.com/thumbnail?id=1exOBlMQYYveF6J02irHIofpI2nUo9U7A&sz=w400', zone:'austral', nota:'Tiempo congelado en azul eterno.' },
    { name:'Lago Pehoé', url:'https://drive.google.com/thumbnail?id=1cY0MZt2mekm40M0lynkh6CypXNX4PZ-G&sz=w400', zone:'austral', nota:'Un zafiro al pie de las torres.' },
    { name:'Muelle La Especuladora', url:'https://drive.google.com/thumbnail?id=1tVxHCA0R_4f4apJse_hvco32R0nVHc3R&sz=w400', zone:'austral', nota:'Puerto Natales y su muelle soñador.' },
    ...
    { name:'Estrecho de Magallanes', url:'https://drive.google.com/thumbnail?id=1awWCm8OHQ2vUPdR1-1XVSyqBXKXDIopk&sz=w400', zone:'austral', nota:'El paso entre dos océanos, cruzado por Magallanes.' },
    { name:'Pingüinos', url:'https://drive.google.com/thumbnail?id=17hXgNFzFJbA5bAGsuposRLeU2-FD9m1-&sz=w400', zone:'austral', nota:'Los dueños del viento patagónico.' },
    { name:'Catedral de Mármol', url:'https://drive.google.com/thumbnail?id=1YUC001Cd2vKwxNyV1ri1nlcDcQY3yxip&sz=w400', zone:'austral', nota:'Esculpidas por el agua en la Patagonia.' },
    { name:'Frío', url:'https://drive.google.com/thumbnail?id=1PzGQxzMDE_REBTRNGds1Yc5sJ5A7pGVX&sz=w400', zone:'austral', nota:'La esencia del sur: hielo, viento y soledad.' },
];
...
var brasilAmazoniaPhotos = [
    ...
    { name:'Encontro das Águas', url:'https://drive.google.com/thumbnail?id=1V6VtbS3x0_VVC0G0pI59D84eO1GMGkWN&sz=w400', zone:'brasil-amazonia', nota:'Donde el Río Negro y el Solimões se unen sin mezclarse.' },
    { name:'Anavilhanas', url:'https://drive.google.com/thumbnail?id=1HBe2uZ-sIIP9tofziKP_wrTtftpdJ1iY&sz=w400', zone:'brasil-amazonia', nota:'Archipiélago de islas en el Amazonas.' },
    { name:'Mamirauá', url:'https://drive.google.com/thumbnail?id=1oh-PoJfIPh7cJpF_n51wp8hCWYz9CRil&sz=w400', zone:'brasil-amazonia', nota:'Reserva de desarrollo sostenible.' },
    { name:'Parque Nacional Jaú', url:'https://drive.google.com/thumbnail?id=12jc8phx7NIhbRcJrxETqLiwu8vaIqIXA&sz=w400', zone:'brasil-amazonia', nota:'El mayor parque nacional de Brasil.' },
    { name:'Ilha de Marajó', url:'https://drive.google.com/thumbnail?id=1N2toYe8PhkvN1kP6ResyUQ1N9iOjXi7U&sz=w400', zone:'brasil-amazonia', nota:'La isla fluvial más grande del mundo.' },
    { name:'Cachoeira do Buracão', url:'https://drive.google.com/thumbnail?id=1FFKq529lUAbKq_bCYs_LVmJApqGY9H68&sz=w400', zone:'brasil-amazonia', nota:'Cascada espectacular en Bahía.' },
];
var brasilNordestePhotos = [
    { name:'Pelourinho', url:'https://drive.google.com/thumbnail?id=1QhdPy02UAFJla3zD0enPU8K9W060jZtL&sz=w400', zone:'brasil-nordeste', nota:'Centro histórico colonial de Salvador, Bahía.' },
    { name:'Olinda', url:'https://drive.google.com/thumbnail?id=1xQkb0kbqsaUmnc3yhxTPqCakwhP4DHg4&sz=w400', zone:'brasil-nordeste', nota:'Ciudad colonial patrimonio de la humanidad.' },
    { name:'Lençóis Maranhenses', url:'https://drive.google.com/thumbnail?id=1UQ0neHQw4pAQJexzJhK05JprAzutALVY&sz=w400', zone:'brasil-nordeste', nota:'Dunas y lagunas de agua dulce en Maranhão.' },
    { name:'Praia de Fortaleza', url:'https://drive.google.com/thumbnail?id=15e54qE6cFuelM_-6tDjlUv9Vj7lW2odT&sz=w400', zone:'brasil-nordeste', nota:'Playas urbanas en Ceará.' },
    { name:'Recife Antigo', url:'https://drive.google.com/thumbnail?id=1dlgEDJZrJyZLHVW662gNq_m9j1MGD7k7&sz=w400', zone:'brasil-nordeste', nota:'Centro histórico de Recife, Pernambuco.' },
    { name:'Porto de Galinhas', url:'https://drive.google.com/thumbnail?id=1MxhAqO-LcyKgeD4IX_Hg6wBpyTMFYNl7&sz=w400', zone:'brasil-nordeste', nota:'Piscinas naturales en Pernambuco.' },
    { name:'Chapada Diamantina', url:'https://drive.google.com/thumbnail?id=1JW4jL9KPtmMecljQDGvut3IVAuzap1i9&sz=w400', zone:'brasil-nordeste', nota:'Sierra y cascadas en Bahía.' },
    { name:'Maragogi', url:'https://drive.google.com/thumbnail?id=1bz8uX8ean0sLLJ6HJgTyU-ipT_uQ2jn8&sz=w400', zone:'brasil-nordeste', nota:'Piscinas naturales en Alagoas.' },
    { name:'São Luís', url:'https://drive.google.com/thumbnail?id=1K3Uk_ltJ63nqKS4nSL0sbRlh8BYfX3y2&sz=w400', zone:'brasil-nordeste', nota:'Capital colonial de Maranhão.' },
    { name:'Jericoacoara', url:'https://drive.google.com/thumbnail?id=1b44ONEp-rdnAZTTCTJ_I_vB6aiWuwe95&sz=w400', zone:'brasil-nordeste', nota:'Paraíso de dunas en Ceará.' },
    { name:'Fernando de Noronha', url:'https://drive.google.com/thumbnail?id=1jId67tc3Nm86R7r5B2Zz1e-yWVH9Z89B&sz=w400', zone:'brasil-nordeste', nota:'Archipiélago volcánico, paraíso marino.' },
    { name:'Itacaré', url:'https://drive.google.com/thumbnail?id=1cYnERkLda9v07IrohC9KblKZh8cDBUys&sz=w400', zone:'brasil-nordeste', nota:'Playas salvajes en Bahía.' },
];
var brasilSudestePhotos = [
    { name:'Cristo Redentor', url:'https://drive.google.com/thumbnail?id=1qOTAGoKGzwfnLuLyMIFkvfJJl0pZX8i0&sz=w400', zone:'brasil-sudeste', nota:'Una de las siete maravillas del mundo moderno.' },
    { name:'Pan de Azúcar', url:'https://drive.google.com/thumbnail?id=1OC3w2XIrDivQuvLChkl3VNwmumCfeakx&sz=w400', zone:'brasil-sudeste', nota:'Ícono de Río de Janeiro, vista 360°.' },
    { name:'Copacabana', url:'https://drive.google.com/thumbnail?id=11NNPwGNt4XTbnv2OqwWUVVSW6ZtZM8F6&sz=w400', zone:'brasil-sudeste', nota:'La playa más famosa del mundo.' },
    { name:'São Paulo', url:'https://drive.google.com/thumbnail?id=1GauznCfN9iiDx0D_H3sYPoDjTcjl52eZ&sz=w400', zone:'brasil-sudeste', nota:'La ciudad más grande de América del Sur.' },
    { name:'Paraty', url:'https://drive.google.com/thumbnail?id=1HhBl4MwHUYtPetv2Ze-kSVYoAGv9Ssgk&sz=w400', zone:'brasil-sudeste', nota:'Pueblo colonial entre montañas y mar.' },
    { name:'Ouro Preto', url:'https://drive.google.com/thumbnail?id=1VLooYnfxPNbFAx3gOVFCCUDlkrWpAEqB&sz=w400', zone:'brasil-sudeste', nota:'Ciudad colonial minera, patrimonio UNESCO.' },
    { name:'Ipanema', url:'https://drive.google.com/thumbnail?id=107PWIhXmDSpTk4cFFQc-pcWVDkNLP6cu&sz=w400', zone:'brasil-sudeste', nota:'Playa inmortalizada por la bossa nova.' },
    { name:'Escadaria Selarón', url:'https://drive.google.com/thumbnail?id=1_LgxD5ZpJlXh2Y_454Ym67vAPZjE4P6J&sz=w400', zone:'brasil-sudeste', nota:'Escaleras de azulejos en Lapa, Río.' },
    { name:'Inhotim', url:'https://drive.google.com/thumbnail?id=1dus_dCr60HicT86fYUoIFmYiUUgqrTrh&sz=w400', zone:'brasil-sudeste', nota:'Museo de arte contemporáneo al aire libre.' },
    { name:'Ilha Grande', url:'https://drive.google.com/thumbnail?id=1IVGT4jBDIRv3dmqJj2m8U-Zjk6ZJxy5j&sz=w400', zone:'brasil-sudeste', nota:'Isla paradisíaca sin autos, en Río.' },
    { name:'Tiradentes', url:'https://drive.google.com/thumbnail?id=1q2gqysU-hfGWJ7ahSmfmRIvZn5dcP7ZM&sz=w400', zone:'brasil-sudeste', nota:'Pueblo colonial histórico en Minas Gerais.' },
